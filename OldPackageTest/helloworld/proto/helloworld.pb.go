...
type HelloReq struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` //编号
}
...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x22, 0x1d, 0x0a, 0x09, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x12,
	0x10, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73,
	0x67, 0x32, 0x31, 0x0a, 0x0f, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x57, 0x6f, 0x72, 0x64, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x12, 0x1e, 0x0a, 0x05, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x09, 0x2e,
...
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: HelloWordServer.Hello:input_type -> HelloReq
	1, // 1: HelloWordServer.Hello:output_type -> HelloResp
...
func (c *helloWordServerClient) Hello(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloResp, error) {
	out := new(HelloResp)
	err := c.cc.Invoke(ctx, "/HelloWordServer/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedHelloWordServerServer can be embedded to have forward compatible implementations.
type UnimplementedHelloWordServerServer struct {
}

func (*UnimplementedHelloWordServerServer) Hello(context.Context, *HelloReq) (*HelloResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Hello not implemented")
}

func RegisterHelloWordServerServer(s *grpc.Server, srv HelloWordServerServer) {
	s.RegisterService(&_HelloWordServer_serviceDesc, srv)
}

func _HelloWordServer_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloWordServerServer).Hello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/HelloWordServer/Hello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWordServerServer).Hello(ctx, req.(*HelloReq))
	}
	return interceptor(ctx, in, info, handler)
}

var _HelloWordServer_serviceDesc = grpc.ServiceDesc{
	ServiceName: "HelloWordServer",
	HandlerType: (*HelloWordServerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Hello",
			Handler:    _HelloWordServer_Hello_Handler,
		},
	},
