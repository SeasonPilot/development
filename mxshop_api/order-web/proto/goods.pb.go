...
var file_goods_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x22, 0x97, 0x01, 0x0a, 0x17, 0x53, 0x75, 0x62, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	...
	0x3b, 0x0a, 0x0d, 0x73, 0x75, 0x62, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72,
	0x79, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x0d, 0x73,
	0x75, 0x62, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x22, 0x54, 0x0a, 0x1a,
	...
	0x61, 0x32, 0xb0, 0x0b, 0x0a, 0x05, 0x47, 0x6f, 0x6f, 0x64, 0x73, 0x12, 0x34, 0x0a, 0x09, 0x47,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x45, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x41,
	0x6c, 0x6c, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x4c, 0x69, 0x73, 0x74,
...
var file_goods_proto_depIdxs = []int32{
	...
	4,  // 2: SubCategoryListResponse.subCategories:type_name -> CategoryInfoResponse
	...
	30, // 17: Goods.GetAllCategoriesList:input_type -> google.protobuf.Empty
	...
	5,  // 41: Goods.GetAllCategoriesList:output_type -> CategoryListResponse
...
func (c *goodsClient) GetAllCategoriesList(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CategoryListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Goods/GetAllCategoriesList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Goods_GetAllCategoriesList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Goods/GetAllCategoriesList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
